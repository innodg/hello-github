...
> [!NOTE]
> [STEP 07 : 저장소 확인](/docs/macos/step07-local-commit-push.md#3단계-저장소-확인)을 참고해 본인의 `my-first-project` 저장소로 이동합니다.
...
> [!TIP]
> 만약 깃허브 데스크탑을 실행 중이지 않다면, `command + 스페이스 바`를 눌러 검색창을 열고 깃허브 데스크탑을 검색한 후 Enter 키를 눌러 실행합니다.
