...
## 🎯 이 단계에서 배우는 것
내 컴퓨터에 있는 저장소(Repository) 파일을 직접 수정하거나 새로 만드는 방법입니다. 파일을 바꾸면 깃허브 데스크탑(GitHub Desktop)에서 어떤 내용을 변경했는지도 함께 확인할 수 있습니다.

## 📂 파일 수정 또는 생성하기

### 1단계: 파일 열기

깃허브(GitHub)로부터 복제해온 저장소(폴더)를 파인더(Finder)에서 찾습니다.

![Finder 열기](/docs/images/macos/step-06-image-01.png)

파인더 창이 열리면, 오른쪽 위 돋보기 버튼을 클릭합니다.
