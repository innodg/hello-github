...
푸시(Push)는 내 컴퓨터(노트북)에서 작업한 내용을 깃허브(GitHub)에 올리는 방법입니다. 푸시(Push)를 하면 내 컴퓨터에서 만든 변경 사항을 깃허브(GitHub)에도 반영할 수 있습니다.
...
> [!IMPORTANT]
> 그리고 주소창의 주소를 메모장 등에 복사해둡니다. 다음 단계에서 이 주소가 필요합니다.
>
> 복사할 주소는 다음과 같은 형태 입니다 : `https://github.com/{{본인 GitHub 아이디}}/my-first-project`
>
